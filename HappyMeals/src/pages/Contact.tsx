...
import heroImg from '../assets/images/pic12.jpg'
...
function Contact() {
  return (
    <section id="contact">
      ...
      <div
        id="contact-form"
        className="flex scroll-mt-24 flex-col items-center justify-center gap-4 px-4 py-16 sm:px-6 sm:py-20 md:py-24"
      >
